...
class TestMetaclass(type):
    ...
    def __call__(cls, *args, **kwargs):
        inst = BlueExposureTest.classes.CreateInstance(cls.__cid__)
        inst.__klass__ = cls
        return inst
...
class TestDir(unittest.TestCase):
    ...
    def test_method_not_in_class_type_dir(self):
        self.assertNotIn("MethodReturningInt", dir(BlueExposureTest.TestMethods))
